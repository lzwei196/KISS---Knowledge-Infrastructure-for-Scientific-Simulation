#!/usr/bin/env python3
"""Preflight check for GEOtop — auto-generated by KDT v5.0"""
...
def main():
    global PASS, FAIL
    print(f"{' PREFLIGHT: GEOtop ':=^60}")
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/GEOtop/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/GEOtop/source/repo/build/geotop", "GEOtop binary", executable=True)
    # Check diagnostics
