# Amanzi_ATS: Windows installation experience
...
Latest recorded attempt: **installed** (2026-09-04T21:29:56+08:00; 142.4 seconds).
Provider: DeepSeek through GeoForge's installation-only HTTP/agent workflow; this was not a manual GUI click-through.

Independent installation check: runnable (script) — usage: run_amanzi.py [-h] --xml_file XML_FILE [--binary BINARY] [--np NP]
