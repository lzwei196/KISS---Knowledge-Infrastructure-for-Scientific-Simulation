...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/DNDC/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/DNDC/dndc_run/DNDC95.exe", "DNDC binary", executable=True)
    # Check diagnostics
