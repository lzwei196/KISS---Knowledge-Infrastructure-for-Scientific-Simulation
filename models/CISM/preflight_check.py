...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/CISM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/CISM/source/repo/builds/mpi/cism_driver/cism_driver", "CISM binary", executable=True)
    # Check diagnostics
