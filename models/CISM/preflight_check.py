#!/usr/bin/env python3
"""Preflight check for CISM — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/CISM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/CISM/source/repo/builds/mpi/cism_driver/cism_driver", "CISM binary", executable=True)
    # Check diagnostics
