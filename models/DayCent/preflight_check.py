...
BIN_DIR = ("KISSPATH_BINARIES/DayCent/source/repo/Linux_Version_491")
DDCENT = os.path.join(BIN_DIR, "DDcentEVI_rev491")
DDLIST = os.path.join(BIN_DIR, "DDlist100_rev491")

EXAMPLE_DIR = ("KISSPATH_BINARIES/DayCent/source/repo/WoosterExampleLinux")
...
def main():
    ...
    check_import("ki_tools_common.load_forcing",
                 "pip install -e KISSPATH_KI_TOOLS_COMMON")
