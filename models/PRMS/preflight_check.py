#!/usr/bin/env python3
"""Preflight check for PRMS — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/PRMS/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/PRMS/source/repo/prms/prms_hpc", "PRMS binary", executable=True)
    # Check diagnostics
