...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/PRMS/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/PRMS/source/repo/prms/prms_hpc", "PRMS binary", executable=True)
    # Check diagnostics
