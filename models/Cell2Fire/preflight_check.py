#!/usr/bin/env python3
"""Preflight check for Cell2Fire — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/Cell2Fire/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/Cell2Fire/source/repo/Cell2Fire/Cell2Fire", "Cell2Fire binary", executable=True)
    # Check diagnostics
