...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/Cell2Fire/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/Cell2Fire/source/repo/Cell2Fire/Cell2Fire", "Cell2Fire binary", executable=True)
    # Check diagnostics
