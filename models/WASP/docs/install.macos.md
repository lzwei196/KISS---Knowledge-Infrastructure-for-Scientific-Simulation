# WASP: declared Python variant on macOS

This recipe installs **hydrocraft-wasp**, the implementation already declared in both the Mac and Windows KI metadata. Its version description is `1.0.0`. It does not install the official upstream WASP application or establish scientific equivalence with it.

The real engine is the existing bundled `tools/run_wasp.py`. Its SHA256 is `6a2f92a70032e1253b2277c5b13d69e55095c46e0b84435cad55b04f4498bd47`. No runner code or equations were changed for this installation contract. The script contains no path-substitution tokens; the materialized workspace copy must retain these exact bytes.
