#!/usr/bin/env python3
"""Preflight check for Ribasim — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_import("ribasim", "ribasim")
    check_import("xarray", "xarray")
    check_import("Model", "Model")
    check_import("Point", "Point")
    check_import("geopandas", "geopandas")
    # Check diagnostics
