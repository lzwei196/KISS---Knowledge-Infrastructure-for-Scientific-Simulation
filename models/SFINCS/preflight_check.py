#!/usr/bin/env python3
"""
Preflight check for SFINCS — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: SFINCS")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary: SFINCS v2.x
    check_file("/mnt/disk1/Hydrocraft_server/model/sfincs/bin/sfincs", "SFINCS v2.x", executable=True)
