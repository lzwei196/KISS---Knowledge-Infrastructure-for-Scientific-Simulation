...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/GR4J___airGR/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_HOME/R/library/airGR/libs/airGR.so", "GR4J___airGR binary", executable=True)
    # Check diagnostics
