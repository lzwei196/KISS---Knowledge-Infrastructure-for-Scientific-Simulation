...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/FATES/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_HOME/cesm/scratch/test_fates/bld/cesm.exe", "FATES binary", executable=True)
    # Check diagnostics
