#!/usr/bin/env python3
"""Preflight check for MOSART — auto-generated by KDT v5.0"""
...
def main():
    ...
    import sys
    sys.path.insert(0, "/home/server/knowledge-dissection-toolkit/auto_dissect/_work/MOSART/venv/lib/python3.12/site-packages")
