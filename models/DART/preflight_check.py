...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/DART/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/DART/source/repo/models/lorenz_63/work/filter", "DART binary", executable=True)
    # Check diagnostics
