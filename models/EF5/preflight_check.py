#!/usr/bin/env python3
"""Preflight check for EF5 — auto-generated by KDT v5.0"""
...
def main():
    global PASS, FAIL
    print(f"{' PREFLIGHT: EF5 ':=^60}")
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/EF5/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/EF5/source/repo/bin/ef5", "EF5 binary", executable=True)
    # Check diagnostics
