...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/EF5/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/EF5/source/repo/bin/ef5", "EF5 binary", executable=True)
    # Check diagnostics
