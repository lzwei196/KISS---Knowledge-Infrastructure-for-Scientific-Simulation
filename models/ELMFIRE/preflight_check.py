...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/ELMFIRE/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/ELMFIRE/source/repo/build/linux/bin/elmfire_2025.1002", "ELMFIRE binary", executable=True)
    # Check diagnostics
