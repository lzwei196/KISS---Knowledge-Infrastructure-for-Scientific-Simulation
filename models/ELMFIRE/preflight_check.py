#!/usr/bin/env python3
"""Preflight check for ELMFIRE — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/ELMFIRE/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/ELMFIRE/source/repo/build/linux/bin/elmfire_2025.1002", "ELMFIRE binary", executable=True)
    # Check diagnostics
