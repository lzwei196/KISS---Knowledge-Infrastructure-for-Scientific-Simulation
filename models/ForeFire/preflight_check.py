...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/ForeFire/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/ForeFire/source/repo/bin/forefire", "ForeFire binary", executable=True)
    # Check diagnostics
