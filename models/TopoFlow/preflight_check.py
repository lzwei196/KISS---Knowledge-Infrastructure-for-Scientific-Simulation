#!/usr/bin/env python3
"""Preflight check for TopoFlow — auto-generated by KDT v5.0"""
...
def main():
    ...
    try:
        ...
        if proc.returncode == 0:
            ...
            print(f"  FAIL  TopoFlow (topoflow): {proc.stderr.decode().strip().split(chr(10))[-1]}")
            FAIL += 1
    except Exception as e:
        print(f"  FAIL  TopoFlow (topoflow): {e}")
        FAIL += 1
    # Check diagnostics
