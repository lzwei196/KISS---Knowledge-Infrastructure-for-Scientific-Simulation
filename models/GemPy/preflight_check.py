#!/usr/bin/env python3
"""Preflight check for GemPy — auto-generated by KDT v5.0"""
...
def main():
    ...
    import sys
    sys.path.insert(0, "KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/GemPy/venv/lib/python3.12/site-packages")
