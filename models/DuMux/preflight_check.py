...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/DuMux/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/DuMux/dumux/dumux/build-cmake/examples/1ptracer/example_1ptracer", "DuMux binary", executable=True)
    # Check diagnostics
