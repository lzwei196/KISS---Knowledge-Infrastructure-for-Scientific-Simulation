#!/usr/bin/env python3
"""
Preflight check for OGGM — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: OGGM")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Python package: OGGM 1.6
    check_import("oggm", "OGGM 1.6")
    # Python package: OGGM core
    check_import("oggm.core", "OGGM core")
    # Directory: RGI v6.2 glacier inventory
    check_dir("KISSPATH_HOME/OGGM/rgi/RGIV62", "RGI v6.2 glacier inventory")
