...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/CLASSIC/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/CLASSIC/source/repo/bin/CLASSIC_serial", "CLASSIC binary", executable=True)
    # Check diagnostics
