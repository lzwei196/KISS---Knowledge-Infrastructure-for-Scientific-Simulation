...
RUN  = "KISSPATH_KI_ROOT/CLASSIC/run/detha"
MET  = f"{RUN}/met"
STATE= "KISSPATH_KI_ROOT/CLASSIC/detached/verify_1"
FLUX = "KISSPATH_OBS/fluxnet/sites/DE-Tha/FULLSET_HH.csv"
FDD  = "KISSPATH_OBS/fluxnet/sites/DE-Tha/FULLSET_DD.csv"
