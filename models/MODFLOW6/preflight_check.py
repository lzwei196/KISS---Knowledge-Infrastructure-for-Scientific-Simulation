#!/usr/bin/env python3
"""
Preflight check for MODFLOW 6 — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: MODFLOW 6")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary: MODFLOW 6.6.1
    check_file("/mnt/disk1/Hydrocraft_server/model/modflow6/mf6.6.1_linux/bin/mf6", "MODFLOW 6.6.1", executable=True)
    # Python package: FloPy (MODFLOW Python interface)
    check_import("flopy", "FloPy (MODFLOW Python interface)")
