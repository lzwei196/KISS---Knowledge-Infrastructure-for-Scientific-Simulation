...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/EPANET/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/EPANET/source/repo/SRC_engines/build/src/run/runepanet", "EPANET binary", executable=True)
    # Check diagnostics
