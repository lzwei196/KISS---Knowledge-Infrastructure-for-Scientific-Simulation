#!/usr/bin/env python3
"""Preflight check for EPANET — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/EPANET/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/EPANET/source/repo/SRC_engines/build/src/run/runepanet", "EPANET binary", executable=True)
    # Check diagnostics
