#!/usr/bin/env python3
"""Preflight check for MARRMoT — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    # MARRMoT runs via Octave (MATLAB alternative). Check octave binary.
    check_file("/usr/bin/octave", "GNU Octave", executable=True)
    # Check diagnostics
