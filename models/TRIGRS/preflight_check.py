...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/TRIGRS/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/TRIGRS/source/trigrs_full/src/TRIGRS/trg", "TRIGRS binary", executable=True)
    # Check diagnostics
