#!/usr/bin/env python3
"""Preflight check for TRIGRS — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/TRIGRS/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/TRIGRS/source/trigrs_full/src/TRIGRS/trg", "TRIGRS binary", executable=True)
    # Check diagnostics
