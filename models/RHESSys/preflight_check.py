...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/RHESSys/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/RHESSys/source/repo/rhessys/rhessys7.4", "RHESSys binary", executable=True)
    # Check diagnostics
