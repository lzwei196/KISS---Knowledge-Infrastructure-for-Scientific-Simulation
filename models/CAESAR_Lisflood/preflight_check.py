...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/CAESAR_Lisflood/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/CAESAR_Lisflood/source/repo/bin/HAIL-CAESAR.exe", "CAESAR_Lisflood binary", executable=True)
    # Check diagnostics
