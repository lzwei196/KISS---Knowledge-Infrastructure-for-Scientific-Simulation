...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/ROMS/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/ROMS/source/repo/build/romsS", "ROMS binary", executable=True)
    # Check diagnostics
