...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/MOM6/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/MOM6/source/repo/.testing/build/symmetric/MOM6", "MOM6 binary", executable=True)
    # Check diagnostics
