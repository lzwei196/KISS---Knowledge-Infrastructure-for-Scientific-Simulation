#!/usr/bin/env python3
"""
Preflight check for ParFlow — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: ParFlow")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary: ParFlow 3.13
    check_file("/mnt/disk1/Hydrocraft_server/model/parflow/install/bin/parflow", "ParFlow 3.13", executable=True)
