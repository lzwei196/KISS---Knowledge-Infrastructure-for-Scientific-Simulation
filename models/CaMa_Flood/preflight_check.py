#!/usr/bin/env python3
"""
Preflight check for CaMa-Flood 4.20 — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: CaMa-Flood 4.20")
    print(f"=" * 60)
    print()
    ...
    # Directory: CaMa global river maps
    check_dir("/mnt/disk1/Hydrocraft_server/model/cmf_v420_pkg/map/glb_15min", "CaMa global river maps")
