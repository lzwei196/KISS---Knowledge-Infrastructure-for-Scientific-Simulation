...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/Daisy/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/Daisy/source/repo/build/linux-gcc-portable/daisy", "Daisy binary", executable=True)
    # Check diagnostics
