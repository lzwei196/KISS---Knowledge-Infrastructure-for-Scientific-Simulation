...
- **Dependencies**: s6_run
- **From documentation**:
  - Run the `test-spawn.dai` file. Depending on you hardware, this might take some time. Once it is done you should see the following directories, each containing the output from a single scenario.
