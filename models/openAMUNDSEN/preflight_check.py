...
def main():
    ...
    import sys
    sys.path.insert(0, "/home/server/knowledge-dissection-toolkit/auto_dissect/_work/openAMUNDSEN/venv/lib/python3.12/site-packages")
    # openAMUNDSEN: use venv python (has deps system python lacks)
    import subprocess
    try:
        proc = subprocess.run(["/home/server/knowledge-dissection-toolkit/auto_dissect/_work/openAMUNDSEN/venv/bin/python3", "-c", "import openamundsen"], 
