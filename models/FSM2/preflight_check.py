#!/usr/bin/env python3
"""Preflight check for FSM2 — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/FSM2/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/FSM2/source/repo/FSM2", "FSM2 binary", executable=True)
    # Check diagnostics
