#!/usr/bin/env python3
"""
Preflight check for LDNDC — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: LDNDC")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary: LDNDC 1.37
    check_file("/mnt/disk1/Hydrocraft_server/model/ldndc/ldndc-1.37.linux64/bin/ldndc", "LDNDC 1.37", executable=True)
