#!/usr/bin/env python3
"""Preflight check for OpenFOAM — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/OpenFOAM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/OpenFOAM/source/repo/platforms/linux64GccDPInt32Opt/bin/foamRun", "OpenFOAM binary", executable=True)
    # Check diagnostics
