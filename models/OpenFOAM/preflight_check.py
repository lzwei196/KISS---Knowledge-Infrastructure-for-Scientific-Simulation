...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/OpenFOAM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/OpenFOAM/source/repo/platforms/linux64GccDPInt32Opt/bin/foamRun", "OpenFOAM binary", executable=True)
    # Check diagnostics
