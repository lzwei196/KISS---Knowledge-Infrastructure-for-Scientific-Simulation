# HEC_HMS: Windows installation experience
...
Latest recorded attempt: **installed** (2026-09-05T00:26:43+08:00; 192.2 seconds).
Provider: DeepSeek through GeoForge's installation-only HTTP/agent workflow; this was not a manual GUI click-through.

Independent installation check: runnable (script) — usage: run_hec_hms.py [-h] --forcing_csv FORCING_CSV
