#!/usr/bin/env python3
"""
Preflight check for DSSAT — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: DSSAT")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary: DSSAT CSM v4.8.5
    check_file("/home/server/DSSAT/build/bin/dscsm048", "DSSAT CSM v4.8.5", executable=True)
