#!/usr/bin/env python3
"""Preflight check for PorePy — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    # PorePy editable install in dissection venv
    import sys
    sys.path.insert(0, "/home/server/knowledge-dissection-toolkit/auto_dissect/_work/PorePy/venv/lib/python3.12/site-packages")
    sys.path.insert(0, "/home/server/knowledge-dissection-toolkit/auto_dissect/_work/PorePy/source/repo/src")
    check_import("porepy", "PorePy")
    # Check diagnostics
