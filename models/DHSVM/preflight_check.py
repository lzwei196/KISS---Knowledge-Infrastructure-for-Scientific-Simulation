...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/DHSVM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/DHSVM/source/repo/build/DHSVM/sourcecode/DHSVM", "DHSVM binary", executable=True)
    # Check diagnostics
