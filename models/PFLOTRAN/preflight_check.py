...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/PFLOTRAN/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/PFLOTRAN/source/pflotran_full/src/pflotran/pflotran", "PFLOTRAN binary", executable=True)
    # Check diagnostics
