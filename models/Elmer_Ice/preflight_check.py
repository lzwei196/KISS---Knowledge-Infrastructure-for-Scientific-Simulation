...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/Elmer_Ice/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/Elmer_Ice/install/bin/ElmerSolver", "Elmer_Ice binary", executable=True)
    # Check diagnostics
