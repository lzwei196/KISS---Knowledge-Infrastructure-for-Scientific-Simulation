...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/LPJmL/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/LPJmL/source/repo/bin/lpjml", "LPJmL binary", executable=True)
    # Check diagnostics
