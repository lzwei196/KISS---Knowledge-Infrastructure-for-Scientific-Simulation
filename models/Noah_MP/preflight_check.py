...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/Noah_MP/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/Noah_MP/source/hrldas/hrldas/run/hrldas.exe", "Noah_MP binary", executable=True)
    # Check diagnostics
