#!/usr/bin/env python3
"""Preflight check for Noah_MP — auto-generated by KDT v5.0"""
...
def main():
    global PASS, FAIL
    print(f"{' PREFLIGHT: Noah_MP ':=^60}")
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/Noah_MP/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/Noah_MP/source/hrldas/hrldas/run/hrldas.exe", "Noah_MP binary", executable=True)
    # Check diagnostics
