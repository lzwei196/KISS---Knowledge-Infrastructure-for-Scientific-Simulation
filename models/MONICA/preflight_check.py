...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/MONICA/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/MONICA/source/repo/_cmake_release/monica-run", "MONICA binary", executable=True)
    # Check diagnostics
