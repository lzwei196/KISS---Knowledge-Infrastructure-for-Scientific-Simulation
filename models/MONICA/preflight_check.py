#!/usr/bin/env python3
"""Preflight check for MONICA — auto-generated by KDT v5.0"""
...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/MONICA/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/MONICA/source/repo/_cmake_release/monica-run", "MONICA binary", executable=True)
    # Check diagnostics
