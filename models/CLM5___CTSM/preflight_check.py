...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/CLM5___CTSM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_HOME/cesm/scratch/test_clm5/bld/cesm.exe", "CLM5___CTSM binary", executable=True)
    # Check diagnostics
