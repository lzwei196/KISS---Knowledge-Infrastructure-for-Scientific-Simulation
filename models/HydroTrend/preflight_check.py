...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/HydroTrend/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/HydroTrend/source/repo/_build/hydrotrend", "HydroTrend binary", executable=True)
    # Check diagnostics
