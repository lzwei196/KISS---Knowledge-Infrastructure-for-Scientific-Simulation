...
| for a machine-readable summary | `knowledge_infrastructure.yaml` | the manifest (package, pipeline, counts). No per-kind projector exists yet for this KI kind — keep it consistent with the KI's contents when editing. |

*Projected 2026-08-17 from the KI's actual contents — 6 components present. Refresh: `python3 ki_tools_common/generate_skill_map.py --ki_dir <this KI>`.*
<!-- KI-MAP:END -->
...
|---|---|
| `tools/convert_forcing_to_esmf.py` | `KISSPATH_PYTHON_ENV/bin/python {KI}/tools/convert_forcing_to_esmf.py --help` |
| `tools/convert_grid_to_esmf.py` | `KISSPATH_PYTHON_ENV/bin/python {KI}/tools/convert_grid_to_esmf.py --help` |
| `tools/generate_regrid_weights.py` | `KISSPATH_PYTHON_ENV/bin/python {KI}/tools/generate_regrid_weights.py --help` |
| `tools/parse_esmf_output.py` | `KISSPATH_PYTHON_ENV/bin/python {KI}/tools/parse_esmf_output.py --help` |
| `tools/run_esmf_application.py` | `KISSPATH_PYTHON_ENV/bin/python {KI}/tools/run_esmf_application.py --help` |
