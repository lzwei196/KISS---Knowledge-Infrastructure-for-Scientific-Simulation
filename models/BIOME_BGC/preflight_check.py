#!/usr/bin/env python3
"""
Preflight check for BIOME-BGC — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: BIOME-BGC")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary (search): BIOME-BGC binary
    check_file("/mnt/disk1/Hydrocraft_server/model/biome-bgc/bgc-src/bgc", "BIOME-BGC binary", executable=True)
