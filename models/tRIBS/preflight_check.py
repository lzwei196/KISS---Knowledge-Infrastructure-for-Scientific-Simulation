...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/tRIBS/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/tRIBS/source/repo/build/tRIBS", "tRIBS binary", executable=True)
    # Check diagnostics
