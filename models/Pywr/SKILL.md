...
|-----------|------|-------|
| **Python package** | `pywr` 1.30.0 | `/home/server/桌面/test/hydro-claude/python_env/bin/python3` |
...
```bash
# Pywr-capable Python:
/home/server/桌面/test/hydro-claude/python_env/bin/python3

# HydroCraft main venv (does NOT have Pywr):
/mnt/disk1/Hydrocraft_server/python_env/bin/python
```
...
```bash
PYWR_PYTHON="/home/server/桌面/test/hydro-claude/python_env/bin/python3"
