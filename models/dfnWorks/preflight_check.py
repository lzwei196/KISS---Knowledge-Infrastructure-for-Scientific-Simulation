...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/dfnWorks/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/dfnWorks/source/repo/DFNGen/DFNGen", "dfnWorks binary", executable=True)
    # Check diagnostics
