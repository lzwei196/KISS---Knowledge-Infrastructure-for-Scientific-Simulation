#!/usr/bin/env python3
"""
Preflight check for Raven — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: Raven")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Binary: Raven v4.1
    check_file("/mnt/disk1/Hydrocraft_server/model/raven/Raven.exe", "Raven v4.1", executable=True)
