...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/DualSPHysics/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/DualSPHysics/source/repo/bin/linux/DualSPHysics5.4CPU_linux64", "DualSPHysics binary", executable=True)
    # Check diagnostics
