...
def main():
    ...
    print()
    check_dir("/mnt/disk1/Hydrocraft_server/models/APSIM/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("/home/server/knowledge-dissection-toolkit/auto_dissect/_work/APSIM/source/repo/bin/Release/net8.0/apsim", "APSIM binary", executable=True)
    # Check diagnostics
