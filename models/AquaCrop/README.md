...
**If ReferenceET is missing from your data source, you MUST compute it** using FAO Penman-Monteith. AquaCrop will NOT run without ET0. This is the #1 difference from DSSAT (which computes ET internally).
