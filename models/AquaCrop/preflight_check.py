#!/usr/bin/env python3
"""
Preflight check for AquaCrop-OSPy — verifies environment before simulation.
...
def main():
    global PASS, FAIL
    print(f"=" * 60)
    print(f"  PREFLIGHT CHECK: AquaCrop-OSPy")
    print(f"=" * 60)
    print()

    # Model-specific checks
    # Python package: AquaCrop-OSPy
    check_import("aquacrop", "AquaCrop-OSPy")
    # Python package: AquaCrop core module
    check_import("aquacrop.core", "AquaCrop core module")
