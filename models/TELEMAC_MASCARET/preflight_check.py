...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/TELEMAC_MASCARET/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/TELEMAC_MASCARET/source/repo/builds/main_gfortran_release/bin/telemac2d", "TELEMAC_MASCARET binary", executable=True)
    # Check diagnostics
