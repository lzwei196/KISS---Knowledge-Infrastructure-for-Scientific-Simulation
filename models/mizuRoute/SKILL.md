...
**Input Source**: mizuRoute takes gridded runoff from upstream hydrological models (VIC, mHM, etc.).
- `convert_vic_runoff.py` — Converts VIC runoff output to mizuRoute input NetCDF format
- `build_network_topology.py` — Builds river network topology from DEM/NHD
- `create_remap_weights.py` — Creates spatial remapping weights for grid-to-reach mapping
