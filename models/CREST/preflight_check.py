...
def main():
    ...
    print()
    check_dir("KISSPATH_KI_ROOT/CREST/knowledge_infrastructure/tools", "KI tools directory")
    # Model-specific binary/package check
    check_file("KISSPATH_INTERNAL_NOT_SHIPPED/auto_dissect/_work/CREST/source/repo/build/ef5", "CREST binary", executable=True)
    # Check diagnostics
