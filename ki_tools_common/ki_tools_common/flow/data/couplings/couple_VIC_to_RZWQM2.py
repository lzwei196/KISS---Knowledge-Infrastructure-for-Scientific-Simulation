#!/usr/bin/env python3
"""Coupling: VIC -> RZWQM2 | Edge: type3b_cross_domain | Generated 2026-04-17
...
def couple_vic_to_rzwqm2(source_dir, target_dir, start, end):
...
if __name__ == "__main__":
    import sys
    result = couple_vic_to_rzwqm2(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
    print(result)
